...
namespace AudioControlApp.RealSenseCamera
{
    public class RSCameraData
    {
        ...
        public RSCameraData(int whichCameraID, bool whichDebugMode, double whichGlobalDisplayScale, double whichAdditionalXOffset, double whichAdditionalZOffset, int whichHres, int whichVres, bool isUsingVBO, bool isRotated, bool isRotatedCW, bool isReversed, bool isInverted)
        {
